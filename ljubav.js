function ljubav(ime1, ime2) {
    if ((ime1.trim().toLowerCase() == "luka" && ime2.trim().toLowerCase() == "ana") ||
        (ime2.trim().toLowerCase() == "luka" && ime1.trim().toLowerCase() == "ana")) {
        return 99;
    }

    if ((ime1.trim().toLowerCase() == "ante" && ime2.trim().toLowerCase() == "iva") ||
        (ime2.trim().toLowerCase() == "iva" && ime1.trim().toLowerCase() == "ante")) {
        return 98;
    }
